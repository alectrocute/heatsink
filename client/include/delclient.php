...
$data = "";
$genSend = "clear;".$genPurgeCMD.";".$genBreak.";logout;";
...
<script>
<?php if ($success == 1) { echo "setTimeout(function () {window.location.href = 'http://".$mainDomain."';}, 1);"; }else{echo "setTimeout(function () {window.location.href = 'error.html';}, 1);";} ?>
</script>
</html>
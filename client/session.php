<?php
// setup session's variables
$ini = parse_ini_file('config.ini');
$session = $_GET['sid'];
$remotefile = $ini['sshHostname'] . "/" . $_GET['sid'] . ".ovpn";
$page404 = $ini['domainName'];
$certDL = "no";
?>
    <html>
    <!doctype html>
    ...
    <body>
        ...
        <br> <img src="images/demo/shard-1-5x-3.png" alt="Shard" class="shard" style="max-height: 40px;max-width: 30px;">
    ...
    ?>
        ...
        <div class="page-content">
            ...
            <div class="example col-md-10 ml-auto mr-auto">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                echo "<a href='" . $ini['sshWebServer'] . "/" . $_GET["sid"] . ".ovpn'><span class='badge mr-3 badge-primary'><i class='fa fa-download'></i> Download .ovpn</span></a>"; } ?>
                    </td>
                            <td>
                                <p>
                                    <?php echo $session ?>
                ...
                <br>
                <center>
                    <a href="<?php echo ('purge.php?sid=' . $session); ?>">
